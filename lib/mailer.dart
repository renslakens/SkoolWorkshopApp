...
jobapply(String recipient, String naam, String workshopnaam, String datum) async {
...
<body style="background-color: #FFFFFF; margin: 0; padding: 0; -webkit-text-size-adjust: none; text-size-adjust: none;">
                                            ...
                                            <tr>
                                                <td class="column column-1" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: left; vertical-align: top; padding-top: 5px; padding-bottom: 5px; border-top: 0px; border-right: 0px; border-bottom: 0px; border-left: 0px;"
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0" class="heading_block" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;" width="100%">
                                                        <tr>
                                                            <td style="padding-left:10px;padding-top:5px;text-align:center;width:100%;">
                                                                <h1 style="margin: 0; color: #393d47; direction: ltr; font-family: Arial, Helvetica Neue, Helvetica, sans-serif; font-size: 23px; font-weight: 700; letter-spacing: normal; line-height: 120%; text-align: left; margin-top: 0; margin-bottom: 0;"><span class="tinyMce-placeholder">Je beschikbaarheid als Workshopdocent {{WORKSHOP_NAAM}} op {{DATUM}} is goed ontvangen</span></h1>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                    <table border="0" cellpadding="10" cellspacing="0" class="paragraph_block" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; word-break: break-word;" width="100%">
                                                        <tr>
                                                            <td>
                                                                <div style="color:#000000;direction:ltr;font-family:Arial, Helvetica Neue, Helvetica, sans-serif;font-size:14px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:left;">
                                                                    <p style="margin: 0;">Beste {{NAAM}},<br/><br/>Je beschikbaarheid als Workshopdocent {{WORKSHOP_NAAM}} op {{DATUM}} is goed ontvangen. Zodra je bent ingepland ontvang je een bevestigingsmail.<br/><br/><strong>Team Skool Workshop</strong></p>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                            ...
                                                            <td>
                                                                <div style="color:#000000;direction:ltr;font-family:Arial, Helvetica Neue, Helvetica, sans-serif;font-size:14px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:left;">
                                                                    <p style="margin: 0;">Telefoon: +31 (0)85 - 065 39 23<br/>Whatsapp: +31 (0)6 - 28 31 88 42<br/>E-mail: <a href="mailto:info@skoolworkshop.nl" rel="noopener" style="text-decoration: underline; color: #0068a5;"
                                                                        ...
                                                                        ons via:<br/><a href="https://www.facebook.com/skoolworkshop" rel="noopener" style="text-decoration: underline; color: #0068a5;" target="_blank">www.facebook.com/skoolworkshop</a><br/>
                                                                        <a
                                                                            href="https://www.twitter.com/skoolworkshop" rel="noopener" style="text-decoration: underline; color: #0068a5;" target="_blank">www.twitter.com/skoolworkshop</a>
                                                                    </p>
                                                                </div>
                                                            </td>
                                                        </tr>
  ...
  final message = Message()
    ..from = Address(username, 'Skool Workshop')
    ..recipients.add(recipient)
    ..subject = 'Bevestiging inschrijving workshop'
    ..html = html.replaceAll("{{NAAM}}", naam).replaceAll("{{WORKSHOP_NAAM}}", workshopnaam).replaceAll("{{DATUM}}", datum);
